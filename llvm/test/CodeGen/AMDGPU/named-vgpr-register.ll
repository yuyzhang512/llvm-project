; RUN: llc -mtriple=amdgpu9.42 -verify-machineinstrs < %s | FileCheck -check-prefixes=CHECK,MFMA %s
; RUN: llc -mtriple=amdgpu9.0a -verify-machineinstrs < %s | FileCheck -check-prefixes=CHECK,MFMA %s
...
; The mnemonic gained an underscore after gfx90a, so match either spelling.
; MFMA-LABEL: {{^}}named_agpr_acc:
; MFMA: v_mfma_f32_16x16x16{{_?}}f16 a[16:19],
; MFMA: v_mfma_f32_16x16x16{{_?}}f16 a[16:19], {{.*}}, a[16:19]
; MFMA-NOT: v_accvgpr
